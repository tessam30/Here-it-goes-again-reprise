# PROJECT: FY23 Q2 Review of Zambia Data Treatment Trends
...
# VIZ VLC / USAID ============================================================================
    ...
    si_save("Images/VL_peds_summary_2022.png", scale = 1.25)
...
# BY AGE AND SEX
    ...
    df_vl %>% 
      ...
      geom_col(aes(vlc), fill = burnt_sienna, alpha = .9, width = 0.75) +
